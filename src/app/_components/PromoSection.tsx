...
function PromoSection() {
  ...
  return (
    <div className="relative h-[1200px] md:h-screen overflow-hidden bg-gray-700">
        ...
        <div className="relative mx-auto max-w-7xl px-4 sm:static sm:px-6 lg:px-8">
          ...
          <div>
            <div className="mt-10">
              ...
              >
                <div className="absolute transform sm:top-0 sm:left-1/2 sm:translate-x-8 lg:top-1/2 lg:left-1/2 lg:translate-x-8 lg:-translate-y-1/2 mt-10">
                    ...
                    <div className="grid shrink-0 grid-cols-1 gap-y-6 lg:gap-y-8">
                      <div className="h-64 w-44 overflow-hidden rounded-lg">
                        <img
                          ...
                          className="size-full hidden xl:block object-cover bg-white"
                        />
                      </div>
                      <div className="h-64 w-44 overflow-hidden rounded-lg">
                        <img
